"""
Django settings for qdui_43209 project.
...
WSGI_APPLICATION = 'qdui_43209.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qdui_43209 API",
    "DESCRIPTION": "API documentation for qdui_43209 App",
    "VERSION": "v1",
}
